...
// Edge &Board::findEdge(Vertex &start, Vertex &end)
// {
//     for (Edge edge : edges)
//     {
//         if ((edge.getVertex1() == &start && edge.getVertex2() == &end) ||
//             (edge.getVertex1() == &end && edge.getVertex2() == &start))
//         {
//             return edge;
//         }
//     }
//     throw std::runtime_error("Edge not found between the given vertices.");
// }
